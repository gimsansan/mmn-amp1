...
- Downloads 3×2 시트(`chdxvc`)를 칸으로 나눠 `002`~`005`를 넣음.
- 흐린 음은 `01_음.png` → `001.webp`. 스 수정이 어려워 단장 `06_스.png` → `006.webp`.
- 목표 크기 456×413(기존 카드 ~444–467×411–414). `sounds.ts`·wav는 그대로.

### 핵심 경로

- `assets/ling6/001.webp` ~ `006.webp`

### 단정 금지

- `미검증`: 실기기 3열 칸에서 한글·얼굴 잘림.
