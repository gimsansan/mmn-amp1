...
export function WrsSessionScreen() {
  ...
  const doClearHistory = useCallback(() => {
    ...
    void clearWrsRecords()
      .then(() => {
        Alert.alert("완료", "단어인지도 연습 기록을 지웠어요.");
  ...
  const confirmClearHistory = useCallback(() => {
    Alert.alert(
      "기록 삭제",
      "단어인지도 연습 기록을 모두 지울까요? 되돌릴 수 없어요. 다른 연습 기록은 그대로예요.",
      [
        ...
        {phase === "idle" ? (
          ...
          >
            <Card style={styles.idleCard}>
              ...
              >
                단음절 단어 하나를 읽어 줘요. 비슷한 소리 보기 네 개 중에서
...
function WrsClearHistoryButton({
  ...
  return (
    <Pressable
      ...
      accessibilityLabel="단어인지도 연습 기록 지우기"
